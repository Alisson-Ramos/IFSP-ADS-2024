(function () {
    ...
    var storedTheme = localStorage.getItem("aurabooks-theme");
    ...
    document.querySelectorAll("[data-theme-toggle]").forEach(function (button) {
        button.addEventListener("click", function () {
            ...
            localStorage.setItem("aurabooks-theme", nextTheme);
        });
    });
    ...
    if (form) {
        ...
        function updatePreview() {
            ...
            var initials = (parts[0] ? parts[0][0] : "A") + (parts[1] ? parts[1][0] : "B");
