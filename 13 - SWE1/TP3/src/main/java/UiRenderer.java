...
public class UiRenderer {
    ...
    private static final String ASSET_VERSION = "tp03-aura-v1";
    ...
    public static void printDocumentStart(PrintWriter out, String title) {
        ...
        out.println("<meta name='theme-color' content='#faf7fc'>");
    ...
    public static void printFooter(PrintWriter out) {
        out.println("<footer class='footer'>Desenvolvido por Alisson Santos para a disciplina de Desenvolvimento Web II (CBTSWE1).</footer>");
