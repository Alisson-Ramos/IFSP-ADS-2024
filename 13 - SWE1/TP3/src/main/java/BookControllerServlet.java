 ...
 * Trabalho Pratico 03 - CRUD de Livros
...
public class BookControllerServlet extends HttpServlet {
    ...
    private void listBooks(HttpServletRequest request, HttpServletResponse response)
        ...
        UiRenderer.printDocumentStart(out, "AuraBooks - Catalog");
        printMenu(out, "list");
        ...
        out.println("<h1 id='catalog-title'>AuraBooks Shelf</h1>");
        out.println("<p class='hero-copy'>Organize o seu acervo pessoal de livros, atualize valores e gerencie o catálogo com uma interface moderna e intuitiva.</p>");
    ...
    private void showForm(HttpServletResponse response, Book book) throws IOException {
        ...
        UiRenderer.printDocumentStart(out, editing ? "Editar Livro" : "Novo Livro AuraBooks");
        printMenu(out, "new");
        out.println("<main class='app-shell page-shell'>");
        ...
        out.println("<h1 id='form-title'>" + (editing ? "Ajuste as informações do título." : "Adicione novas obras ao seu catálogo premium.") + "</h1>");
    ...
    private void printMenu(PrintWriter out, String active) {
        ...
        out.println("<a href='index.html' class='brand brand-link' aria-label='AuraBooks dashboard'><span class='brand-mark' aria-hidden='true'>A</span><span>AuraBooks</span></a>");
