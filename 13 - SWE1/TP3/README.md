# TP03-AuraBooks - CRUD de Livros

**Autor:** Alisson Santos, Nayara Soares
...
```bash
git clone https://github.com/alisson-santos/TP03-AuraBooks.git
cd TP03-AuraBooks
```
...
- **GitHub:** https://github.com/alisson-santos/TP03-AuraBooks
